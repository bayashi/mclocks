...
* `openBrowserAtStart`: यदि `true` पर सेट किया जाता है, तो `mclocks` शुरू होने पर डिफ़ॉल्ट ब्राउज़र में वेब सर्वर URL स्वचालित रूप से खुलता है (डिफ़ॉल्ट: `false`)
...
स्टैटिक फ़ाइल होस्टिंग के अलावा, वेब सर्वर में ड्रैग-एंड-ड्रॉप आधारित कंटेंट व्यूअर वर्कफ़्लो भी शामिल है: जब आप mclocks की घड़ी विंडो पर कोई फ़ाइल या डायरेक्टरी ड्रैग-एंड-ड्रॉप करते हैं, तो उसे अस्थायी लोकल URL के जरिए खोला और देखा जा सकता है।
ये अस्थायी URL mclocks बंद होने पर हटा दिए जाते हैं।
