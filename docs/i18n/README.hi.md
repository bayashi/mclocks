...
ऑनलाइन `config.json` जनरेटर: https://bayashi.github.io/mclocks/mclocks-config-generator/

### घड़ी के लिए config.json उदाहरण

`config.json` फ़ाइल को नीचे दिखाए अनुसार JSON प्रारूप में लिखा जाना चाहिए (JSONC समर्थित)।
...
नीचे के भाग `config.json` में सेट किए जा सकने वाले फ़ील्ड बताते हैं।
...
शॉर्टकट तालिकाएँ (सहायता दिखाना, कॉन्फ़िगरेशन और डिस्प्ले फ़ॉर्मेट, टाइमर, स्टिकी नोट, क्लिपबोर्ड दिनांक-समय, टेक्स्ट रूपांतरण) **[`mclocks-cheat-sheet.md`](../mclocks-cheat-sheet.md)** में हैं।
...
* `content.markdown.enablePreviewApi`: `true` होने पर CLI से `POST /preview` के माध्यम से Markdown का ब्राउज़र में पूर्वावलोकन सक्षम करता है (डिफ़ॉल्ट: `false`)।
...
**Markdown** **परिवर्तनों को स्वतः पहचानकर ब्राउज़र में रीयल-टाइम में अपडेट** करता है (**`source`** मोड में रेंडर किया गया दृश्य)।
...
`editor` की अपनी `web` कॉन्फ़िगरेशन में निम्नलिखित जोड़ें:
...
**`mclocks-datetime-util`** [MCP](https://modelcontextprotocol.io/) सर्वर [Cursor](https://www.cursor.com/) और [Claude Desktop](https://claude.ai/download) जैसे सहायकों को समय क्षेत्रों में तारीख/समय के प्रश्नों के उत्तर देने देता है। यह mclocks `config.json` पढ़ सकता है।

सेटअप, टूल और विकास: **[bayashi/mclocks-datetime-util](https://github.com/bayashi/mclocks-datetime-util)** ([npm](https://www.npmjs.com/package/mclocks-datetime-util) पर भी)।
