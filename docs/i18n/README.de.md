...
Der **`mclocks-datetime-util`** [MCP](https://modelcontextprotocol.io/)-Server ermöglicht Assistenten wie [Cursor](https://www.cursor.com/) und [Claude Desktop](https://claude.ai/download), Zeit- und Datumsfragen über Zeitzonen hinweg zu beantworten und mehr. Er kann Ihre mclocks-`config.json` lesen.

Setup, Tools und Entwicklung: **[bayashi/mclocks-datetime-util](https://github.com/bayashi/mclocks-datetime-util)** (auch auf [npm](https://www.npmjs.com/package/mclocks-datetime-util)).
