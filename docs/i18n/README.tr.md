...
**`mclocks-datetime-util`** [MCP](https://modelcontextprotocol.io/) sunucusu, [Cursor](https://www.cursor.com/) ve [Claude Desktop](https://claude.ai/download) gibi asistanların saat dilimleri arası tarih/saat sorularını yanıtlamasını sağlar. mclocks `config.json` dosyanızı okuyabilir.

Kurulum, araçlar ve geliştirme: **[bayashi/mclocks-datetime-util](https://github.com/bayashi/mclocks-datetime-util)** ([npm](https://www.npmjs.com/package/mclocks-datetime-util) üzerinde de mevcut).
