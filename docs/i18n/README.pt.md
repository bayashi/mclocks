...
O servidor [MCP](https://modelcontextprotocol.io/) **`mclocks-datetime-util`** permite que assistentes como [Cursor](https://www.cursor.com/) e [Claude Desktop](https://claude.ai/download) respondam perguntas de data/hora entre fusos, e mais. Pode ler o seu `config.json` do mclocks.

Configuração, ferramentas e desenvolvimento: **[bayashi/mclocks-datetime-util](https://github.com/bayashi/mclocks-datetime-util)** (também no [npm](https://www.npmjs.com/package/mclocks-datetime-util)).
