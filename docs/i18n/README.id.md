...
Server [MCP](https://modelcontextprotocol.io/) **`mclocks-datetime-util`** memungkinkan asisten seperti [Cursor](https://www.cursor.com/) dan [Claude Desktop](https://claude.ai/download) menjawab pertanyaan tanggal/waktu lintas zona waktu, dan lainnya. Dapat membaca `config.json` mclocks Anda.

Setup, tools, dan pengembangan: **[bayashi/mclocks-datetime-util](https://github.com/bayashi/mclocks-datetime-util)** (juga di [npm](https://www.npmjs.com/package/mclocks-datetime-util)).
